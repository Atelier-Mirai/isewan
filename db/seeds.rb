...
Event.create([
  { start_date: "2019-06-09", end_date: nil, category: "preliminary",
    name: "逗子市長杯", place: "神奈川県逗子市逗子海岸", nor: nil, result: nil,
  ...
  { start_date: "2021-05-30", end_date: nil, category: "preliminary",
    name: "Himeno cup 2021 the 24th", place: "神奈川県逗子市逗子海岸", nor: "http://www.kayawind.com/race/2021/himenocup2021.pdf", result: nil,
  ...
  { start_date: "2021-06-26", end_date: nil, category: "preliminary",
    name: "35th MID CUP", place: "静岡県浜名湖 大崎海岸 ビーチスマリーナ沖", nor: "https://jw-a.org/wp-content/uploads/2021/05/2021midcup-kouji3.pdf", result: nil,
  ...
  { start_date: "2022-07-02", end_date: "2022-07-03", category: "both",
    name: "テクノクラス、国体WS級中部選手権大会", place: "愛知県知多市新舞子", nor: nil, result: nil,
  ...
  { start_date: "2022-07-10", end_date: nil, category: "both",
    name: "伊勢湾カップ新舞子セレクションレース テクノ、テクノプラス、国体WS級", place: "愛知県知多市新舞子", nor: nil, result: nil,
  ...
  { start_date: "2021-07-03", end_date: "2021-07-04", category: "preliminary",
    name: "九州選手権大会", place: "大分県杵築市住吉浜リゾート", nor: nil, result: nil,
    contact: "BUZZ", phone: "0978-63-8774", url: nil, email: nil,
    display: false  },

  { start_date: "2022-07-09", end_date: nil, category: "regional",
    name: "国体 愛知県予選", place: "愛知県知多市新舞子", nor: nil, result: nil,
    contact: "大会事務局", phone: "090-1476-2206", url: "https://isewan.herokuapp.com", email: "ayf-wind@sd5.so-net.ne.jp",
    display: true  },
  { start_date: "2022-08-21", end_date: nil, category: "regional",
    name: "名古屋港ボート天国 ナゴヤチャレンジカップ", place: "名古屋港ヨットトレーニングセンター", nor: nil, result: nil,
    contact: "大会事務局", phone: "090-1476-2206", url: "https://isewan.herokuapp.com", email: "ayf-wind@sd5.so-net.ne.jp",
    display: true  }
])
