...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference("Gallery.count") do
      post galleries_url, params: { gallery: { display: @gallery.display, title: @gallery.title, type: @gallery.type, url: @gallery.url } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { display: @gallery.display, title: @gallery.title, type: @gallery.type, url: @gallery.url } }
